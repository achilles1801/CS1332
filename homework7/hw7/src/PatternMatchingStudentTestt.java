 ...
 * @version 1.0
 */
public class PatternMatchingStudentTestt {
    ...
    @Test(timeout = TIMEOUT)
    public void testGalilRuleNoMatch() {
        /*
            pattern: sell
            text: sea lions trains cardinal boardwalk
            indices: -
    ...
    /*
    Same test as boyer moore with the comparisons changed to reflect Galil Rule
     */
    @Test(timeout = TIMEOUT)
    public void testGalilRuleMatch() {
        /*
            pattern: sell
            text: She sells seashells by the seashore.
            indices: 4
         ...
         */
        assertEquals(sellAnswer, PatternMatching.boyerMooreGalilRule(sellPattern,
                sellText, comparator));
        assertTrue("Did not use the comparator.",
                comparator.getComparisonCount() != 0);
        assertEquals("Comparison count was " + comparator.getComparisonCount()
    ...
    /*
    Galil Rule Test with a non-zero failure table Last value, comparisons changed to reflect Galil Rule
     */
    @Test(timeout = TIMEOUT)
    public void testGalilRuleMatchFT() {
        /*
            pattern: ababa
            text: ababaaababa
            indices: 0, 6
     ...
     */
    @Test(timeout = TIMEOUT)
    public void testGalilRuleMultipleMatches() {
        /*
            pattern: ab
            text: abab
            indices: 0, 2
     ...
     */
    @Test(timeout = TIMEOUT)
    public void testGalilRuleLongerText() {
        /*
            pattern: sea lions trains cardinal boardwalk
            text: sell
            indices: -
